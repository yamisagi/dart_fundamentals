...
void main() {
  ...
  // 4 VERİ TÜRÜ - 4 DATA TYPES
  //  String - int - double - bool
  // -----------------------------
  // String - Metinsel Veri ( Text type )
  // int - Tam sayı ( integers )
  // double - Ondalık sayı ( Floating point numbers )
  // bool - Doğru ya da Yanlış ( True or False )
  //
  // -----------------------------------------
